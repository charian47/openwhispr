...
export default function UnifiedModelPicker({
  ...
  */
  ...
  // Memoize progress display - must be before any early returns to satisfy React hooks rules
              ...
              >
                <div className="flex-1">
                  ...
                  <div className="flex items-center gap-2 mt-1">
                    ...
                    {isDownloaded && <span className={styles.badges.downloaded}>✓ Downloaded</span>}
                  </div>
                </div>
